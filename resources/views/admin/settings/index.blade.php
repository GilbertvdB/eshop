        ...
        <div class="max-w-7xl mx-44 sm:px-6 lg:px-8">
            ...
            <div class="flex">
                <div class="w-1/5">
                    ...
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'General')">General</button>
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'Logo')">Site Logo</button>
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'Footer-seo')">Footer &amp; SEO</button>
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'Social-links')">Social Links</button>
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'Analytics')">Analytics</button>
                    <button class="tablinks block text-black py-3 px-4 w-full text-left focus:outline-none hover:bg-sky-200" onclick="openSettings(event, 'Payments')">Payments</button>
                    </div>
                </div>
