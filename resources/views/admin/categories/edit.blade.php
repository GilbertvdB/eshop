                        ...
                        <form action="{{ route('admin.categories.update') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-1 mb-2 w-full focus:border-sky-500 focus:ring-sky-500" type="text" name="name" :value="old('name', $targetCategory->name)" placeholder="Enter category name"  required/>
                                        ...
                                        <div class="w-1/4">
                                            @if ($targetCategory->image != null)
                                                <figure class="mt-2" style="width: 80px; height: auto;">
                                                    <img src="{{ asset('storage/'.$targetCategory->image) }}" id="categoryImage" class="" alt="img">
                                                </figure>
                                            @else
                                ...
                                <div class="flex items-center mt-4">
                                    <button type="submit" class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">Update Category</button>
                                    &nbsp;&nbsp;&nbsp;
