        ...
        <div class="sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <div class="border border-gray-300 bg-white h-86 shadow-sm sm:rounded-lg">
                    ...
                    <div id="logo" class="tabcontent border bg-white border-gray-300 w-3/5 h-fit ml-4 p-4 hidden">
                        <h3 class="text-2xl font-bold">Site Logo</h3>
                        @include('admin.settings.includes.logo')
                    </div>

                    <div id="footer-seo" class="tabcontent border bg-white border-gray-300 w-3/5 h-fit ml-4 p-4 hidden">
                        <h3 class="text-2xl font-bold">Footer &amp; SEO</h3>
                        @include('admin.settings.includes.footer_seo')
                    </div>

                    <div id="social-links" class="tabcontent border bg-white border-gray-300 w-3/5 h-fit ml-4 p-4 hidden">
                        <h3 class="text-2xl font-bold">Social Links</h3>
                        @include('admin.settings.includes.social_links')
                    </div>

                    <div id="analytics" class="tabcontent border bg-white border-gray-300 w-3/5 h-fit ml-4 p-4 hidden">
                        <h3 class="text-2xl font-bold">Analytics</h3>
                        @include('admin.settings.includes.analytics')
                    </div>

                    <div id="payments" class="tabcontent border bg-white border-gray-300 w-3/5 h-fit ml-4 p-4 hidden">
